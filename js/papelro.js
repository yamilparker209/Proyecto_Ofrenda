...
export default function papelroX({ x, y, z }) {
...
var borMat = new THREE.MeshLambertMaterial({ color: 0xFFFF });
...
// grupos
 ...
 var pica = new THREE.Group();
   ...
   const papelro = new THREE.Group();
  papelro.add(pica, pica2, pica3);
  papelro.position.set(x, y, z);
